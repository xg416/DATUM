...
def get_args():
    ...
    parser.add_argument('--train_path', type=str, default='/home/zhan3275/data/New_LMDB/train_lmdb/', help='path of training imgs')
    parser.add_argument('--train_info', type=str, default='/home/zhan3275/data/New_LMDB/train_lmdb/train_info.json', help='info of training imgs')
    parser.add_argument('--val_path', type=str, default='/home/zhan3275/data/New_LMDB/test_lmdb/', help='path of validation imgs')
    parser.add_argument('--val_info', type=str, default='/home/zhan3275/data/New_LMDB/test_lmdb/test_info.json', help='info of testing imgs')   
