...
def get_args():
    ...
    parser.add_argument('--data_path', type=str, default='/home/zhan3275/data/New_LMDB/test_lmdb/', help='path of validation imgs')
    parser.add_argument('--info_path', type=str, default='/home/zhan3275/data/New_LMDB/test_lmdb/test_info.json', help='info of testing imgs')  
